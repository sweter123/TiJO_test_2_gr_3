...
var fragments = function (text)
{
    ...
    var mapping = {
        middleButton: element.bind(null , by.id('psrod')),
        warningAlert: element.bind(null , by.id('danger')),
        input: element.bind(null , by.id('szukacz')),
        header: element.bind(null , by.id('glowa'))
    };
